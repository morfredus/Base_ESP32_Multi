...
### Version actuelle : v0.8.2 (2025-12-13)
**Nouveautés de la v0.8.2 (Optimisation) :**
- ⚡ **SPI matériel pour TFT** : Utilisation du SPI matériel pour de meilleures performances
- 🎨 **Couleurs Adafruit** : Remplacement de `COLOR_*` par les constantes officielles `ST77XX_*`

**Nouveautés de la v0.8.1 :**
- 🔧 **Cohérence des noms de pins** : Tous les noms de pins normalisés avec le préfixe `PIN_`
- 📋 **board_config.h comme référence unique** pour tous les noms de pins du projet

**Nouveautés de la v0.8.0 :**
- 🎮 **Système de boutons avancé** : BOOT (reboot), BTN1 (RGB), BTN2 (Buzzer)
- 🎨 **NeoPixel intelligente** : Indique WiFi et état de reboot
- 🔊 **Feedback sonore** : Buzzer piézo